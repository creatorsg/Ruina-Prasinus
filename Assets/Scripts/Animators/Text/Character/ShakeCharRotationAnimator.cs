...
{
    public class ShakeCharRotationAnimator : AbstractCharAnimator
    {
        ...
        protected override Sequence CreateCharAnimationSequence(int index)
        {
            ...
            .Append(Animator.DOShakeCharRotation(index, _duration, _targetValue, _vibrato, _randomness, _fadeOut))
            .SetEase(_ease);
