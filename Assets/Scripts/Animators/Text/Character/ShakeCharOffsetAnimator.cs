...
{
    public class ShakeCharOffsetAnimator : AbstractCharAnimator
    {
        [Tooltip("애니메이션 목표값입니다.")]
        [SerializeField] private Vector3 _targetValue = new(0, 5f, 0);
        ...
        protected override Sequence CreateCharAnimationSequence(int index)
        {
            ...
            .Append(Animator.DOShakeCharOffset(index, _duration, _targetValue, _vibrato, _randomness, _fadeOut))
            .SetEase(_ease);
