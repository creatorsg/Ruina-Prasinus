...
{
    public class CharFadeAnimator : AbstractCharAnimator
    {
        [Tooltip("상대값으로 적용할지 여부를 결정합니다.")]
        [SerializeField] private bool _relative = false;
        [Tooltip("애니메이션 목표값입니다.")]
        [SerializeField, Range(0f, 1f)] private float _targetValue = 1f;
        ...
        protected override Sequence CreateCharAnimationSequence(int index)
        {
            ...
            .Append(Animator.DOFadeChar(index, _targetValue, _duration))
