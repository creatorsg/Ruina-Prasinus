...
public class ModelMove
{
    ...
    public void Update(float moveInput, bool dashPressed, bool dashIsHeld, initialState state, float dt, bool isGrounded)
    {
    ...
    void UpdateWalk(float input, initialState state, float dt)
    {
        CurrentDashSpeed = 0f;
    ...
    void UpdateDash(initialState state, float dt, bool isGround)
    {
        dashTimer += dt;
    ...
    void EndDash(initialState state)
    {
        isDashing = false;
        CurrentDashSpeed = 0f;
