...
public class MainPlayer : CharacterBase
{
    ...
    public override void SetUp()
    {
        ...
        _move[(int)MoveBehavior.DashJump] = new DashJump(_data.JumpPower, _data.JumpAccelPower, _data.JumpRemainTime);
